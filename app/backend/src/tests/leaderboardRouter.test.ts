...
describe('---------------- Rota Leaderboard ----------------', () => {
  ...
  describe('2 - GET /Leaderboard/away', () => {
    ...
    describe('Casos de sucesso', () => {
      ...
      it('busca todas as estaticias dos times jogando em fora!', async () => {
        sinon
          .stub(sequelize, 'query')
  ...
  describe('3 - GET /Leaderboard', () => {

    describe('Casos de sucesso', () => {

      it('busca todas as estaticias dos times jogando em casa e fora!', async () => {
        sinon
          .stub(sequelize, 'query')
          .resolves([leaderboardHomeAway, []])

        const httpResponse = await chai.request(app)
          .get('/leaderboard');

        expect(httpResponse.status).to.equal(200);
        expect(httpResponse.body).to.deep.equal(leaderboardHomeAway);
        sinon.restore();
      })
